...
class PromptEvaluator:
    ...
    def evaluatePrompt(self, prompt, humanPrompt = False, humanPromptcsvPath = ""):
    ...
    def serialize(self, path, input_text):
        parts = []
    ...
    def faithfulness_score(self, document: str, summary: str) -> float:
    ...
    def relevance_score(self, document: str, summary: str) -> float:
    ...
    def rogueL_score(self, text_a: str, text_b: str) -> float:
